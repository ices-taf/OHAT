...
render(
  output_file = paste(gsub(" ", "_", series), "__", gsub(" ", "_", compartment), "__2023.html", sep = ""),
  output_dir = "html",
...
if (FALSE) {
  ...
  # series = "Norway_10A2 Skallneset AG Mytilus edulis SB Not_applicable",
  #  compartment = "biota"
  #)
...
#  rm(params)
  render(
    "assessment_platform.Rmd",
      params = list(
      compartment = "biota",
      series = "France_Baie de Lampaul CD Mytilus edulis SB Not_applicable"
    )
  )
}
