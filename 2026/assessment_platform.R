# to live test:
# https://tafinternal.ices.dk/worker2/OAT/13704%20AS%20Gadus%20morhua%20LI/biota/2026
...
calling_url <- paste0(
  ...
  "&matrix=", compartment, "&year=2026"
)

# print log file header
cat("\n\nStarting assessment platform for OHAT 2026\n")
...
harsat::report_assessment(
  ...
  output_dir = "html",
  output_file = paste(gsub(" ", "_", series_id), compartment, "2026.html", sep = "__")
)
